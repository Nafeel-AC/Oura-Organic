...
export function Hero({ brandName, heroTitle, heroSubtitle }) {
    ...
    return (
        <section className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-stone-50 px-6 pt-32 pb-20 md:px-12">
            ...
            <div className="container mx-auto grid grid-cols-1 gap-12 lg:grid-cols-12 items-center">
                <div className="z-10 flex flex-col justify-center lg:col-span-8">
                    <motion.h1
                        initial="hidden"
                        animate="visible"
                        variants={{
                        ...
                        className="font-serif text-5xl leading-[0.95] text-green-950 md:text-7xl lg:text-[5vw] xl:text-[5.5vw] tracking-tighter"
                    >
                        {heroTitle.map((word, i) => (
                            <div key={i} className="inline-block overflow-hidden mr-3 md:mr-4 lg:mr-5">
                                <motion.span
                                    variants={{
                                        hidden: { y: "100%" },
                ...
                <div className="relative h-[60vh] lg:col-span-4 lg:h-[70vh] w-full">
